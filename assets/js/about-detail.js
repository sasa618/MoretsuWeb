  ...
  const leaders = {
    ceo: {
      ...
      blocks: [
        ...
        {
          type: 'body',
          text: '常識の外側にある未来。AIの時代だからこそ、個の「意志」が循環する社会を。',
        },
        {
          type: 'body',
        ...
        {
          type: 'body',
          text: '私は、良い意味で「普通」から外れた人を増やしたい。自分の感性に蓋をせず、やりたいことを追求し、それが同時にお金を稼ぎ、他者の幸福にも繋がっていく。そんな「個の熱狂」が経済を回し、次の挑戦者を生む。この「意志の循環」を社会に実装することが私の使命です。',
        },
        {
          type: 'body',
        ...
        {
          type: 'body',
          text: 'それは、誰かに用意された選択肢の中から選ぶのではなく、自ら選んだ道を切り開いていきたかったからです。自分のビジョンを現実にするには、自ら旗を掲げ、全責任を背負って荒野を切り拓く道しかありませんでした。この決断は、自分一人のためではありません。共に歩む社員、そしてその背後にいる家族までが、自分の人生を誇れるようでなければ、組織としての成功はないと考えています。',
        },
        {
          type: 'body',
          text: '「今が、失敗を恐れずに挑戦できるラストチャンスかもしれない」その切実な危機感を武器に、私はこの挑戦にすべてを賭けています。私たちは、「自らの選択を、自らの力で正解に導くこと」にこだわり、人生そのものをモーレツに肯定できる集団であり続けます。',
        },
        {
          type: 'bio',
          text: '三橋智大 / Tomohiro Mitsuhashi\n電気通信大学大学院 博士後期課程在学中。シミュレーション科学・人工知能の研究に従事しながら、エンジニアリングとマーケティングの両領域でフリーランスとして実務経験を積む。テクノロジーとビジネスをつなぐ力を軸に、環境課題や人口減少といった社会課題の解決を目指し、株式会社モーレツを設立。',
        },
      ],
    },
    coo: {
      ...
      blocks: [
        {
          type: 'single',
          text: 'AI時代の静寂を、情熱で焼き尽くせ。',
        },
        {
          type: 'triple',
          text: '取締役COO 井上颯大 Souta Inoue',
        },
        {
          type: 'triple',
          text: '1歳で小児がんを克服した原体験を「燃え盛る使命感」に変え、21歳で三橋と共に創業し取締役COOに就任。圧倒的な営業力と情熱を組織のエンジンに据え、AIが加速させる現代にこそ「人間臭さ」を最大の社会的価値へ。無機質なシステムに血を通わせ、社会の停滞を突き破る、爆速で時代のアップデートを牽引する若きリーダーの挑戦とは。',
        },
        {
          type: 'double',
        ...
        {
          type: 'body',
          text: 'そして私が組織運営で貫いているのは、「集団成功主義」です。かつて個人で活動していた時代に感じたのは、一人で勝つことの限界でした。組織として動くからこそ、誰かが苦境にある時に手を差し伸べ、共に壁を乗り越える「愛」が必要になります。家族よりも長い時間を共にする仲間だからこそ、誰よりも深い時間を過ごし、全員で勝利を味わいたい。そんな「任される喜び」と「主体的に動ける環境」が溢れる組織文化を、私が醸成していきたいです。',
        },
        {
          type: 'double',
    ...
    return blocks
      .map(({ type, text }) => {
        ...
        switch (type) {
          ...
          case 'bio':
            return `<section class="about-detail__bio"><h3 class="about-detail__bio-title">経歴</h3><p class="about-detail__bio-text">${toHtmlWithBreaks(text)}</p></section>`;
          case 'body':
          default:
            return `<p class="about-detail__block about-detail__block--body">${toHtmlWithBreaks(text)}</p>`;
        }
      })
      .join('');
  }
